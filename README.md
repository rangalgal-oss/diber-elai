...
הכתבה בעברית, מקומית ופרטית, ל-Windows. מדברים — וזה נכתב בכל תוכנה. שום הקלטה לא יוצאת מהמחשב.
...
דורש Windows 10/11 (64-bit). כרטיס NVIDIA מומלץ למהירות (עובד גם בלעדיו, איטי יותר).

נבנה על מודל העברית של [ivrit.ai](https://www.ivrit.ai) ו-OpenAI Whisper (רישיון Apache-2.0).